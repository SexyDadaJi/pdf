...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <form action="splitter1" method="post" enctype="multipart/form-data">
    <head>
      <br>
      <br>
      <br>
      <h1 style="text-align: center;">Split PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Separate one page or a whole set for easy conversion into independent PDF files.</h2>
      </center>
