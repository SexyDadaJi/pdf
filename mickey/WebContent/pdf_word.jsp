...
@media screen and (max-width: 500px) {
  ...
  <head>
      ...
      <br>
      <br>
      <h1 style="text-align: center;">PDF to Word Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Easily convert your PDF files into easy to edit DOC and DOCX documents. The converted WORD document is almost 100% accurate.</h2>
      </center>
