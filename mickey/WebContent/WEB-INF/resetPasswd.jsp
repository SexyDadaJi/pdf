...
<br>
  ...
  <div class="centered">
    <h2 style="margin-left: 30px">Enter new password</h2>
    <p style="margin-left: 20px">Enter your new password and retype to confirm your new password.</p>
    <form action=newPasswd method="post">
  <div class="container">
    <input type="password" placeholder="new password" name="password" style="width: 300px"><br>
   <input type="password" placeholder="confirm password" name="password_1" style="width: 300px"><br>
...
<div class="split right">
  <div class="centered">
    <h1>New Password!</h1>
    <p>Please enter your new password which will be used in future for further login.</p>
