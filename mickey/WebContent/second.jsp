...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <head>
      ...
      <br>
      <br>
      <h1 style="text-align: center;"> PDF to JPG Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Convert each PDF page into a JPG or extract all images contained in a PDF.</h2>
      </center>
