...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <head>
      ...
      <br>
      <br>
      <h1 style="text-align: center;">Compress PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Reduce file size while optimizing for maximal PDF quality.</h2>
      </center>
