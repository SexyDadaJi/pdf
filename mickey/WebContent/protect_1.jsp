...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <body>
      ...
      <a  href="back.jsp">MERGE PDF</a>
        ...
        <a href="compress_pdf">COMPRESS PDF</a>
         <div class="dropdown">
    ...
    <form action="protect1" method="post" enctype="multipart/form-data">
    <head>
      <br>
      <br>
      <br>
      <h1 style="text-align: center;">Protect PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Protect PDF files with a password. Encrypt PDF documents to prevent unauthorized access.</h2>
      </center>
       
           <article>
            <section>
             <center>
             <label for="file" class="button" style="float: center;width: 22%;" name="userfile" >Select Your PDF Files</label> 
             <input type="file" name="userfile" id="file" class="inputfile" multiple />
             <br>
              <input type="Password" placeholder="Enter Your Password" class="button" style="float: center;width: 22%;" name="password"><br>
  ...
  ;background-image: url("https://www.shareico7n.net/data/512x512/2016/07/09/118690_drive_512x512.png") title="Select Pdf from drop box"><span class="glyphicon glyphicon-folder-open"></span></button></a>
             </center> </section>
