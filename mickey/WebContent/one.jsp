...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <form action="JPEGtoPdf"  method="post" enctype="multipart/form-data">
    <head>
      <br>
      <br>
      <br>
      <h1 style="text-align: center;">JPG to PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Convert JPG images to PDF in seconds. Easily adjust orientation and margins.</h2>
      </center>
       
           <article>
            <section>
             <center>
             <label for="file" class="button" style="float: center;width: 22%;" name="b1" >Select Your JPG Files</label> 
