...
<div class="split left">
	<button style="float: right;padding-right: 30px;margin-right: 10px;   background-color: #800000;
color: white; text-align: center;height: 30px;padding-left: 20px; ">Create an Account</button>
  <div class="centered">
