...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <head>
      ...
      <br>
      <br>
      <h1 style="text-align: center;">Add Watermark to Your PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Stamp an image or text over your PDF in seconds. </h2>
      </center>
