...
@media screen and (max-width: 500px) {
  .navbar a {
    ...
    <head>
      ...
      <br>
      <br>
      <h1 style="text-align: center;">Unlock PDF Files</h1>
    </head>
    <center>
      <br>
      <h2 style="font-family: Arial, Helvetica, sans-serif" >Remove PDF password security, giving you the freedom to use your PDFs as you want.</h2>
      </center>
